...
import com.wingon.pbn.adapter.B1_ProductListAdapter;
import com.wingon.pbn.adapter.GoodListLargeListActivityAdapter;
import com.wingon.pbn.model.GoodsListModel;
...
import com.wingon.pbn.protocol.PAGINATED;
       ...
       final LinearLayout mainView = (LinearLayout) findViewById(R.id.keyboardLayout1);
        ...
        if (null != filter_string)
        {
            try
            {
                ...
                filter =new com.wingon.pbn.protocol.FILTER();
            ...
            case 1:
            {
                if(null != data)
                {
                    ...
                    if (null != filter_string)
                    {
                        ...
                        {
                            JSONObject filterJSONObject = new JSONObject(filter_string);
                            FILTER filter = new com.wingon.pbn.protocol.FILTER();
                            filter.fromJson(filterJSONObject);
